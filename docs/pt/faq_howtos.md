...
Sim! A partir da versão 1.8.0, o ATBCmder fornece pacotes universais com suporte nativo para Macs **Apple Silicon (M1/M2/M3/M4, arquitetura ARM64)** e **Intel (x86_64)** no macOS 12.0 ou superior.
