...
| **Синхронизация каталогов (Sync Dirs)** | `Shift+F12` / `⇧F12` | `Shift+F12` | `cm_SyncDirs` | Сравнивает и синхронизирует каталоги двух панелей. | 
...
## 4. Синхронизация каталогов (Sync Dirs) (`Shift+F12` / `⇧F12` / `cm_SyncDirs`)
...
| **Синхронизация каталогов (Sync Dirs)**| Открыть каталоги синхронизации | `Shift+F12` / `⇧F12` | `Shift+F12` | `cm_SyncDirs` | 
| **Синхронизация каталогов (Sync Dirs)**| Начать сравнение каталогов | `Alt+C` / `⌥C` | `Enter` | — | 
| **Синхронизация каталогов (Sync Dirs)**| Отменить сравнение/синхронизацию | Нажмите `Stop` | `Esc` | — | 
