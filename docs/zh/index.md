...
![自然语言搜索文件](images/semantic_command.png)  
*通过语义化命令使用自然语言快速搜索文件。*

![平铺展开嵌套目录](images/branch_view.png)  
*分支视图：一键将多层嵌套文件夹内的所有文件平铺显示。*

![快捷命令工具栏](images/middle_toolbar.png)  
*中间工具栏：快捷访问核心常用命令与操作。*

![SMB、SFTP、FTP远程访问](images/smb_sftp_ftp远程访问.png)  
*SMB、SFTP、FTP远程访问*

![压缩与解压文件](images/压缩_解压文件.png)  
*压缩与解压文件*

![图像查看器](images/图像查看器.png)  
*图像查看器*

![多功能搜索](images/多功能搜索.png)  
*多功能搜索*

![快捷访问路径](images/快捷访问路径.png)  
*快捷访问路径*

![批量重命名](images/批量重命名.png)  
*批量重命名*

![文件夹同步](images/文件夹同步.png)  
*文件夹同步*

![水平面板显示](images/水平面板显示.png)  
*水平面板显示*
...
![语意化搜索](images/语意化搜索.png)  
*语意化搜索*

![音乐播放器](images/音乐播放器.png)  
*音乐播放器*
